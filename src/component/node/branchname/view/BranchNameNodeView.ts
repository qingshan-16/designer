...
import BranchNameNode from "./BranchNameNode.vue";

class BranchNameNodeView extends HtmlNode {
    ...
    constructor(props: any) {
        ...
        // 创建虚拟节点，绑定父实例的上下文
        this.vNode = createVNode(BranchNameNode, {
            model: model,
...
export default BranchNameNodeView;
