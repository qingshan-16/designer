...
import MulticastNode from "./MulticastNode.vue";

class MulticastNodeView extends HtmlNode {
    ...
    constructor(props: any) {
        ...
        // 创建虚拟节点，绑定父实例的上下文
        this.vNode = createVNode(MulticastNode, {
            model: model,
...
export default MulticastNodeView;
