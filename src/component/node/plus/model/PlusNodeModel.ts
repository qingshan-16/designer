...
import {NODE_Z_INDEX, PLUS_NODE_HEIGHT, PLUS_NODE_WIDTH,} from "@/constant";
import {getLocale} from "@/util/LocaleUtil";
import Designer from "@/core/Designer";
import {PLUS_NODE} from "@/constant/ComponentType";
import {Layout} from "@/type";

class PlusNodeModel extends HtmlNodeModel {
    constructor(data: LogicFlow.NodeConfig, graphModel: GraphModel) {
        ...
        this.xModelType = PLUS_NODE;
    }

    setAttributes() {
        this.width = PLUS_NODE_WIDTH;
        this.height = PLUS_NODE_HEIGHT;
