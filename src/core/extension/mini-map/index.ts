...
type Position = LogicFlow.Position;
type MiniMapOption = MiniMap.MiniMapOption;
type MiniMapPosition = MiniMap.MiniMapPosition;
...
export class MiniMap {
    ...
    private setOption(options: MiniMapOption) {
        ...
        this.bottomPosition =
            topPosition !== undefined ? undefined : bottomPosition;
    ...
    private initMiniMap() {
        ...
        this.lfMap.on("node:delete,edge:delete", ({data}) => {
            Designer.getInstance().idGenerator.deleteId(data.id);
        });
        // minimap中禁用adapter。
